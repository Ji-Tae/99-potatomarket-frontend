  ...
  return (
    <Layout>
      ...
      <Container>
        <div
          className='contents'
          style={{ width: '60%', display: 'flex', flexDirection: 'row', marginTop: '30px', justifyContent: 'center' }}>
          <div
            ...
            <div
              ...
              <p style={{ fontSize: '15px', color: '#9e7979', fontWeight: 'bold' }}>
                이미지 파일을 드래그해서 등록해주세요
              </p>
              {previewUrl && (
                <img
                  src={previewUrl}
                  alt='미리보기 이미지'
                  className='preview'
                  style={{ display: 'block', position: 'absolute', left: 0, height: 0, width: '100%', height: '100%' }}
                />
              )}
            </div>
          </div>
